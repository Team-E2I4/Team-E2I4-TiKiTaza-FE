  ...
  return (
    <main className='flex pb-[4rem] gap-[3rem]'>
      <section className='flex flex-col gap-[3rem] w-[25rem]'>
        ...
        <div className='bg-yellow-100 h-[18rem] w-full'>유저 프로필</div>
      </section>
      <section className='flex-1 grid grid-cols-2 grid-rows-[5rem_auto] grid-flow-col gap-[3rem]'>
        ...
        <div className='bg-yellow-100 row-start-1'>방 만들기</div>
        <div className='bg-yellow-100 row-start-2 col-start-1 col-span-2'>
          방 목록
        </div>
      </section>
    </main>
